            ...
            public void run() {
                if (mAuth.getCurrentUser() != null)
                {
                    DatabaseLoadCompleteListener loadCompleteListener = () -> {
                            startActivity(new Intent(SplashscreenActivity.this, InitialParamsActivity.class));
                            finish();
                        };
                ...
                {
                    startActivity(new Intent(SplashscreenActivity.this, PreLoginActivity.class));
                    finish();
                }
            }
        },3000);
